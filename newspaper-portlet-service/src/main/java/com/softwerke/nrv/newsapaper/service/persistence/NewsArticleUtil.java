...
/**
 * The persistence utility for the news article service. This utility wraps {@link NewsArticlePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class NewsArticleUtil {
    private static NewsArticlePersistence _persistence;
     ...
     */
    public static void clearCache(NewsArticle newsArticle) {
        getPersistence().clearCache(newsArticle);
    }
     ...
     */
    public static List<NewsArticle> findWithDynamicQuery(
     ...
     */
    public static NewsArticle update(NewsArticle newsArticle)
        throws SystemException {
        return getPersistence().update(newsArticle);
    }
    ...
    public static NewsArticle update(NewsArticle newsArticle,
        ...
        return getPersistence().update(newsArticle, serviceContext);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(newsArticle);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(newsArticles);
    }
    ...
    */
    public static com.softwerke.nrv.newsapaper.model.NewsArticle create(
        long articleId) {
    ...
    */
    public static com.softwerke.nrv.newsapaper.model.NewsArticle remove(
        long articleId)
    ...
    public static com.softwerke.nrv.newsapaper.model.NewsArticle updateImpl(
        com.softwerke.nrv.newsapaper.model.NewsArticle newsArticle)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(newsArticle);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.softwerke.nrv.newsapaper.model.NewsArticle findByPrimaryKey(
        long articleId)
        throws com.liferay.portal.kernel.exception.SystemException,
            com.softwerke.nrv.newsapaper.NoSuchNewsArticleException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.softwerke.nrv.newsapaper.model.NewsArticle fetchByPrimaryKey(
        long articleId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.softwerke.nrv.newsapaper.model.NewsArticle> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static NewsArticlePersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (NewsArticlePersistence) PortletBeanLocatorUtil.locate(com.softwerke.nrv.newsapaper.service.ClpSerializer.getServletContextName(),
                    NewsArticlePersistence.class.getName());

            ReferenceRegistry.registerReference(NewsArticleUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(NewsArticlePersistence persistence) {
    }
}
